  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a
            href="https://github.com/shixigege/DMTI"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 py-3 text-ming-sepia hover:text-ming-ink transition-colors duration-300 hover:scale-105"
          >
            ...
            <span className="text-sm">shixigege/DMTI</span>
          </a>
        </motion.div>
      </motion.div>
